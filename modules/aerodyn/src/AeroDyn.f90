...
module AeroDyn
   ...
   public :: AD_UpdateStates_Custom            ! @djc: version of Update states that recalculates the blade node positions and orientations
                                               !   instead of interpolating them because interpolations seems to throw things off 
...
contains
   ...
   !----------------------------------------------------------------------------------------------------------------------------------
    ...
    function CalcBladePitch(HubOrient, BladeRootOrient, BladeRootRefOrient) result(theta)
       real(R8Ki), dimension(1:3, 1:3), intent(in) :: HubOrient, BladeRootOrient, BladeRootRefOrient
       real(R8Ki), dimension(1:3, 1:3)             :: BladePitchRotMatrix
       real(ReKi)                                  :: theta
