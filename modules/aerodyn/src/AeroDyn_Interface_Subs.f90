   ...
   real(ReKi), dimension(1:3),     intent(in   ) :: hubPos
   real(ReKi), dimension(1:3,1:3), intent(in   ) :: hubOri        ! The hub's initial orientation matrix (local to global)
   real(ReKi), dimension(1:3),     intent(in   ) :: hubVel
   real(ReKi), dimension(1:3),     intent(in   ) :: hubRotVel
   ...
   real(ReKi), dimension(1:3,1:3)              :: extrapOri  ! holds extrapolated orientation matrix
   ! local data
   ...
   function ExtrapOrientationFromRotVel(orientation, rotVel, time) result(orientation_prime)
      real(ReKi), dimension(1:3,1:3), intent(in) :: orientation ! the global to local orientation matrix
      real(ReKi), dimension(1:3),     intent(in) :: rotVel ! rotational velocity in axis-angle form
      real(DbKi),                     intent(in) :: time   ! time to extrapolate to

      real(ReKi), dimension(1:3)             :: theta_prime
      real(ReKi), dimension(1:3,1:3)         :: orientation_prime
      real(ReKi), dimension(1:3)             :: xBase, yBase, zBase, xBase_prime, yBase_prime, zBase_prime
   ...
   real(ReKi), dimension(1:3), intent(in) :: v ! vector to rotate
   ...
   !----------------------------------------------------------------------------------------------------------------------------------
    ...
    subroutine AD_UpdateStates_Custom( t, n, u, utimes, p, x, xd, z, OtherState, m, errStat, errMsg )
    !..................................................................................................................................
    ...
    integer(intKi)                               :: ErrStat2          ! temporary Error status
    character(ErrMsgLen)                         :: ErrMsg2           ! temporary Error message
    character(*), parameter                      :: RoutineName = 'AD_UpdateStates_Custom'
    ...
    end subroutine AD_UpdateStates_Custom